...
RUN apt-get update && apt-get install -y wget nano libmnl0 libsctp1 libxml2 libcurl4 libpcre3 libssl3 default-mysql-client ipsec-tools && rm -rf /var/lib/apt/lists/*
